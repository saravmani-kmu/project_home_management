  ...
  return (
    <div className="flex min-h-svh items-center justify-center bg-stone-50 px-4">
      <div className="w-full max-w-sm rounded-xl border border-stone-200 bg-white p-8 text-center shadow-sm">
        ...
        <h1 className="mt-4 text-xl font-semibold text-stone-900">Hearth</h1>
        ...
        <div className="mt-6 flex flex-col gap-3">
          <a
            href={googleLoginUrl('login')}
            className="flex items-center justify-center gap-2 rounded-lg border border-stone-300 px-4 py-2.5 text-sm font-semibold text-stone-700 transition hover:bg-stone-50"
          >
            <GoogleIcon />
            Log in with Google
          </a>
          <a
            href={googleLoginUrl('signup')}
            className="flex items-center justify-center gap-2 rounded-lg bg-amber-500 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-amber-600"
          >
            <GoogleIcon />
            Sign up with Google
          </a>
